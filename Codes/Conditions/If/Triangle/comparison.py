print("This code calculates the area of triangle using if and compare which is bigger.")
...
# Check if the area of triangle first is greater than triangle second.
if area1 > area2:
